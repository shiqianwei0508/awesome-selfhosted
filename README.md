...
- [Software](#software)
  ...
  - [日历和联系人 - CalDAV或CardDAV服务器](#calendar--contacts---caldav-or-carddav-servers)
  - [日历和联系人 - CalDAV或CardDAV基于Web的客户端](#calendar--contacts---caldav-or-carddav-web-based-clients)
  - [通信 - 自定义通信系统](#communication---custom-communication-systems)
  - [通信 - 电子邮件 - 完整的解决方案](#communication---email---complete-solutions)
  - [通信 - 电子邮件 - 邮件投递代理](#communication---email---mail-delivery-agents)
  - [通信 - 电子邮件 - 邮件传输代理](#communication---email---mail-transfer-agents)
  - [通信 - 电子邮件 - 邮件列表和时事通讯](#communication---email---mailing-lists-and-newsletters)
  - [通信 - 电子邮件 - 网络邮箱客户端](#communication---email---webmail-clients)
